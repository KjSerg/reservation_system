...
<div class="article">
    ...
    <div class="article__main">
        <div class="article__heading">
            ...
            <div class="article__date"><img class="svg" src="<?php echo $assets; ?>img/date.svg" alt="img" /><span><?php echo get_the_date( 'j/n/Y', get_the_ID() ); ?></span></div>
        </div>
        <div class="article__content">
            ...
            <div class="article__btn">
                <a class="main_btn" href="<?php the_permalink(); ?>">
                    <span class="main_btn_inner">READ MORE</span>
                </a>
            </div>
        </div>
    </div>
